    ...
    >
      <div className="w-full mb-4 flex items-center justify-between">
        ...
        <div className="flex md:hidden gap-x-2 items-center">
            ...
            <button className="rounded-full p-2 bg-white flex items-centerjustify-center hover:opacity-75 transition">
             ...
             bg-white
              ...
              focus:outline-none focus:ring-4
               ...
               rounded-full text-sm px-5 py-2.5
                text-center me-2 mb-2 dark:bg-white-600
                 dark:hover:bg-white-700
                  dark:focus:ring-white-800">Log in</button>
        </div>
        </>
       </div>
